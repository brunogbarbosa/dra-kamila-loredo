...
const pillars = [
  { title: 'Identidade', copy: 'Seus traços e a sua história são o nosso ponto de partida.', Icon: UserRound },
  { title: 'Naturalidade', copy: 'Escolhas que valorizam a sua expressão, sem excessos.', Icon: Leaf },
  { title: 'Precisão', copy: 'Cada decisão nasce de uma avaliação cuidadosa e individual.', Icon: Heart },
];
  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">Harmonizar é olhar para você: sua expressão, seus desejos e tudo o que torna a sua beleza única.</p>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src={site.images.essence} alt="Dra. Kamila Loredo em retrato profissional com um tablet." fill sizes="(max-width:700px) 112vw, (max-width:1100px) 82vw, 67vw"/>
      </figure>
